# usertree-spawner backend protocol version 1
...
is resolved beneath `/usr/libexec/usertree-spawner/backends`.
...
```text
USERTREE_SPAWNER_BACKEND_PROTOCOL=1
...
The payload is opaque to usertree-spawner. Version 1 limits it to 4096 bytes.
