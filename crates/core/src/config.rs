...
pub const DEFAULT_CONFIG_PATH: &str = "/etc/usertree-spawner/config.toml";
pub const DEFAULT_CONTROL_SOCKET: &str = "/run/usertree-spawner/control.sock";
pub const DEFAULT_RUNTIME_DIRECTORY: &str = "/run/usertree-spawner";
pub const DEFAULT_SUPERVISOR_PATH: &str = "/usr/libexec/usertree-spawner-supervisor";
pub const INTERNAL_PAM_SERVICE: &str = "usertree-spawner-manager";
...
impl Default for Config {
    fn default() -> Self {
        Self {
            backend: "/usr/libexec/usertree-spawner/backends/s6".into(),
            backend_config_dir: "/etc/usertree-spawner/backends".into(),
